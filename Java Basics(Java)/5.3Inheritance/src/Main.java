...
public class Main {
    public static void main(String[] args) {
        //Math Teacher
    	MathTeacher mathTeacher = new MathTeacher(30,"Clear Lake High School", 6);
        ...
        System.out.println(mathTeacher.getRole()); // Method inherited
        ...
        //System.out.println(teacher.favoriteNumber) Cannot use attribute specific to Math Teacher
    }
}